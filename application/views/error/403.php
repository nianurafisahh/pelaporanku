...
<body id="page-top" style="background : #000000;">
        ...
        <div class="container-fluid" style="margin-top : 100px;">
          ...
          <div class="text-center">
            <div class="error mx-auto text-white" data-text="404">403</div>
            <p class="lead text-white mb-5">Access Denied</p>
            <p class="text-white mb-0">Halaman yang anda cari tidak valid untuk anda kunjungi</p>
